...
4.  **UI Modernization: Choose Game Screen**
    ...
    - **Статус:** ✅ Завершено (реализован гибридный подход с сохранением оригинальных ассетов).
...
6.  **Контент: Аудит актуальности вопросов**
    - **Задача:** Проверка всех футбольных вопросов на соответствие текущим фактам. Consolidation of EN, RU, HY questions into `app/questions_audit.json`.
    - **Статус:** ✅ Завершено.


7.  **Архитектура: ViewModel & Flow**
...
---
*Последнее обновление: 03.04.2026 (Аудит завершен)*
